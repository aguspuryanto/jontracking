...
gsValues['protocol_list'] = [
    ...
    {name: 'concoxgt02'},
    {name: 'concoxgt03'},
    {name: 'gt06', cmd: 'engine_resume,engine_stop'},
    {name: 'gt06edlt', cmd: 'engine_resume,engine_stop'},
    {name: 'gt100'},
    {name: 'gt300', cmd: 'engine_resume,engine_stop'},
    {name: 'gt710', cmd: 'engine_resume,engine_stop'},
    {name: 'gt800', cmd: 'engine_resume,engine_stop'},
    {name: 'jc100', cmd: 'engine_resume,engine_stop'},
    {name: 'jm01', cmd: 'engine_resume,engine_stop'},
    {name: 'jmvl01', cmd: 'engine_resume,engine_stop'},
    {name: 'x1', cmd: 'engine_resume,engine_stop'},
    {name: 'cybergraphy'},
    {name: 'dct'},
    {name: 'detero'},
