			...
			<div class="row">				
				<div class="block width55">
					<div class="container">
						...
						<div class="row2">
							...
							<div class="width60">
								<select id="dialog_settings_event_type" class="select width100" onchange="settingsEventSwitchType();"/>
									...
									<option value="proximity"><? echo $la['PROXIMITY']; ?></option>
						...
						<div class="row2">
							<div class="width40"><? echo $la['DISTANCE']; ?> (<? echo $la["UNIT_DISTANCE"]; ?>)</div>
	...
	<div class="row">
		...
		<div class="report-block block width60">
			<div class="container last">	
				...
				<div class="row2">
					<div class="width40"><? echo $la['RFID_IBUTTON_BLUE_ID']; ?></div>
					...
					<div class="row2">
						...
						<div class="width50">
							<select id="dialog_settings_object_sensor_type" class="select width100" onchange="settingsObjectSensorType();">
								...
								<option value="blueid"><? echo $la['BLUE_ID']; ?></option>
	...
	<div id="settings_object">
		...
		<div id="settings_object_main">
			<div class="row">
				...
				<div class="row2" <? if ($gsValues['SIM_NUMBER'] == 'false') { echo 'style="display: none;"'; }?>>
		...
		<div id="settings_object_accuracy">
			<div class="scroll-y">
				<div class="row">
					...
					<div class="row2">
						<div class="width65"><span class="container"><? echo $la['IGNORE_FUEL_CONSUMPTION_DURING_STOPS']; ?></span></div>
						<div class="width5"></div>
				...
				<div class="row">
					...
					<div class="row2">
						<div class="width65"><span class="container"><? echo $la['UNASSIGN_OBJECT_DRIVER_AFTER_IGNITION_IF_OFF']; ?></span></div>
						<div class="width5"></div>
					...
					<div class="row2">
						<div class="width65"><span class="container"><? echo $la['FORWARD_THIS_OBJECT_LOCATION_DATA_TO_ANOTHER_OBJECT']; ?></span></div>
						<div class="width5"></div>
	...
	<div id="settings_main">
		...
		<div id="settings_main_sms">
			...
			<div class="row">
				...
				<div class="row2">
					...
					<div class="width25"><input id="settings_main_sms_gateway" type="checkbox" class="checkbox" checked="checked"/></div>
				</div>
				<div class="row2">
		...
		<div id="settings_main_my_account">		
			...
			<div class="scroll-y">
				...
				<!-- New feature -->
				<div class="row">
					<div class="title-block"><? echo $la['MY_ACCOUNT']; ?></div>
					<div class="row2">
						<div class="width40">Delete Account</div>
						<div class="width40">
							<input type="hidden" name="account_id" id="settings_main_delete_account_id" value="<?=$_SESSION["user_id"]?>"/>
							<input type="password" name="account_password" id="settings_main_delete_password" maxlength="20" placeholder="Masukkan Password Anda"/>
							<button type="button" class="button icon-delete icon" onclick="settingsDeleteAccount();">Hapus Akun</button>
						</div>
					</div>
				</div>
			</div>
