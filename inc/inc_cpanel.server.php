...
<div id="cpanel_manage_server" style="display:none;">
	<div class="float-left cpanel-title">
		<div class="version"><? echo $gsValues['VERSION']; ?></div>
	...
	<div id="manage_server_tabs" class="clearfix">
		<ul>
			...
			<li class="cp-email"><a href="#manage_server_email" id="manage_server_email_tab"><? echo $la['EMAIL']; ?></a></li>
			...
			<div class="width-1000">
				...
				<div class="row">
					...
					<div class="row2">
						...
						<div class="width10">
							<select id="cpanel_manage_server_backup_time" class="select width100" <? if (file_exists('config.hosting.php')) { echo ' disabled'; } ?>>
								<? include ("inc/inc_dt.hours_minutes.php"); ?>
							</select>
						</div>
						<div class="width1"></div>
						<div class="width39"><input id="cpanel_manage_server_backup_email" class="inputbox width100" maxlength="50" <? if (file_exists('config.hosting.php')) { echo ' disabled'; } ?>/></div>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					...
					<div class="row2">
						...
						<div class="width235">
							<div class="ui-img-container">
								<?
									$path_favicon_ico = $gsValues['PATH_ROOT'].'favicon.ico';
									$path_favicon_png = $gsValues['PATH_ROOT'].'favicon.png';

									if (file_exists($path_favicon_png))
									{
										echo '<img class="favicon" id="cpanel_manage_server_favicon" src="favicon.png" />';
									}
									else
									{
										if (file_exists($path_favicon_ico))
										{
			...
			<div class="width-1000">
				...
				<div class="row">
					...
					<div class="row2">
						...
						<div class="width1"></div>
						<div class="width8">
							<input id="cpanel_manage_server_account_expire_period" class="inputbox width100" onkeypress="return isNumberKey(event);" maxlength="4" placeholder="<? echo $la['EXAMPLE_SHORT']; ?> 1"/>
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					...
					<div class="row2">
						...
						<div class="width1"></div>
						<div class="width8">
							<input id="cpanel_manage_server_notify_obj_expire_period" onkeypress="return isNumberKey(event);" class="inputbox width100" maxlength="4" placeholder="<? echo $la['EXAMPLE_SHORT']; ?> 1"/>
						</div>
					</div>
					<div class="row2">
						<div class="width50">
						...
						<div class="width1"></div>
						<div class="width8">
							<input id="cpanel_manage_server_notify_account_expire_period" onkeypress="return isNumberKey(event);" class="inputbox width100" maxlength="4" placeholder="<? echo $la['EXAMPLE_SHORT']; ?> 1"/>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="row2">
						<div class="width50">
							<? echo $la['OBJECT_CONTROL_DEFAULT_TEMPLATES']; ?>
						</div>
						<div class="width10">
		...
		<div id="manage_server_billing">
			<div class="width-1000">
				...
				<div id="cpanel_manage_server_billing_paypalv2">
					<div class="row">
						<div class="title-block"><? echo $la['PAYPAL_V2_GATEWAY']; ?></div>
						<div class="row2">
							<div class="width50">
								<? echo $la['PAYPAL_ACCOUNT']; ?>
							</div>
							<div class="width50">
								<input id="cpanel_manage_server_billing_paypalv2_account" class="inputbox width70" maxlength="50" placeholder="<? echo $la['EXAMPLE_SHORT']; ?> my@email.com"/>
							</div>
						</div>
						<div class="row2">
							<div class="width50">
								<? echo $la['PAYPAL_CLIENT_ID']; ?>
							</div>
							<div class="width50">
