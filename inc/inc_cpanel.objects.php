<div id="dialog_object_add" title="<? echo $la['ADD_OBJECT'] ?>">		
        <div class="row">
                ...
                <div class="row2">
                        ...
                        <div class="width10"><input id="dialog_object_add_object_expire" class="checkbox" type="checkbox" onChange="objectAddCheck();" disabled="<?=($_SESSION["cpanel_privileges"] == 'super_admin' || $_SESSION["cpanel_privileges"] == 'admin' ? '' : 'disabled') ?>"/></div>
                        <div class="width50"><input class="inputbox-calendar inputbox width100" id="dialog_object_add_object_expire_dt" disabled="<?=($_SESSION["cpanel_privileges"] == 'super_admin' || $_SESSION["cpanel_privileges"] == 'admin' ? '' : 'disabled') ?>"/></div>
                </div>
                <div class="row2">
                        <div class="width100">
